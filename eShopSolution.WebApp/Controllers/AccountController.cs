...
namespace eShopSolution.WebApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        {
            registerRequest.FirstName = "Nguyễn";
            registerRequest.LastName = "Mi";
            registerRequest.Dob = DateTime.Now;
            registerRequest.Email = "mimi@gmail.com";
            registerRequest.PhoneNumber = "086615522";
